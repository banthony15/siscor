...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2019 a las 05:35:41
...
--
-- Estructura de tabla para la tabla `control_delete_soporte`
--

CREATE TABLE `control_delete_soporte` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `control_delete_soporte`
--

INSERT INTO `control_delete_soporte` (`id`, `persona_id`, `fecha_action`) VALUES
(1, 5, '2019-04-29 03:32:41');
...
--
-- Estructura de tabla para la tabla `log_delete_soporte`
--

CREATE TABLE `log_delete_soporte` (
  `id` int(11) NOT NULL,
  `soporte_id` varchar(45) NOT NULL,
  `fecha_action` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Volcado de datos para la tabla `log_delete_soporte`
--

INSERT INTO `log_delete_soporte` (`id`, `soporte_id`, `fecha_action`) VALUES
(7, '30', '2019-04-29 03:32:41');
...
(22, 5, 27, '2019-04-29 02:55:51'),
(23, 5, 28, '2019-04-29 03:02:17'),
(24, 5, 29, '2019-04-29 03:16:57'),
(25, 5, 30, '2019-04-29 03:32:37');
...
--
-- Volcado de datos para la tabla `log_update_requerimiento`
--

INSERT INTO `log_update_requerimiento` (`id`, `persona_id`, `requerimiento_id`, `numero`, `fecha_action`) VALUES
(2, 4, 381, '344', '2019-04-28 22:02:39');
...
--
-- Volcado de datos para la tabla `log_update_ticket`
--

INSERT INTO `log_update_ticket` (`id`, `persona_id`, `micro_ticket_id`, `fecha_action`) VALUES
(1, 5, 15, '2019-04-28 22:23:12');
...
(15, '2019-04-25 13:51:27', 69, '8580318', 79, 95, 'x3elimloc', 'samsung', 'iphone4s', 91, 88, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'pruebaaaaaaaaa', 'asdsdsaaaaaaaaaaaaaaaaaaaaaaaa', 163, '2019-04-18T02:01');
...
(74, '2018-10-08 18:20:16', 70, '3888000', 116, 76, '01', '0000-00-00', '0000-00-00', 64, 78, 'El sistema, no valida que la fecha de emisiÃ³n sea menor a la fecha RemisiÃ³n. Debe enviar un mensaje que diga â€œLa fecha de emisiÃ³n debe ser mayor a la fecha de remisiÃ³nâ€.', '', '', 14),
...
--
-- Disparadores `soporte`
--
DELIMITER $$
CREATE TRIGGER `log_delete` AFTER DELETE ON `soporte` FOR EACH ROW begin
...
--
-- Indices de la tabla `control_delete_soporte`
--
ALTER TABLE `control_delete_soporte`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `log_delete_soporte`
--
ALTER TABLE `log_delete_soporte`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `log_update_requerimiento`
--
ALTER TABLE `log_update_requerimiento`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT de la tabla `control_delete_soporte`
--
ALTER TABLE `control_delete_soporte`
...
--
-- AUTO_INCREMENT de la tabla `log_delete_soporte`
--
ALTER TABLE `log_delete_soporte`
...
--
-- AUTO_INCREMENT de la tabla `log_update_requerimiento`
--
ALTER TABLE `log_update_requerimiento`
...
--
-- Filtros para la tabla `log_update_requerimiento`
--
ALTER TABLE `log_update_requerimiento`
  ADD CONSTRAINT `log_update_requerimiento_ibfk_1` FOREIGN KEY (`persona_id`) REFERENCES `usuario` (`id`);
...
--
ALTER TABLE `log_update_ticket`
  ADD CONSTRAINT `log_update_ticket_ibfk_1` FOREIGN KEY (`persona_id`) REFERENCES `usuario` (`id`);
