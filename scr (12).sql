...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 16, 2018 at 09:32 PM
...
--
-- Table structure for table `micro_analista`
--
...
--
-- Dumping data for table `micro_analista`
--

INSERT INTO `micro_analista` (`id`, `persona_id`, `micro_tickets_id`) VALUES
(1, 4, 1),
(2, 4, 2),
(3, 5, 3),
(4, 5, 4),
...
--
-- Table structure for table `micro_persona`
--
...
--
-- Dumping data for table `micro_persona`
--
...
--
-- Table structure for table `micro_tecnico`
--
...
--
-- Dumping data for table `micro_tecnico`
--
...
--
-- Table structure for table `micro_tickets`
--
...
--
-- Dumping data for table `micro_tickets`
--
...
(1, '2017-07-26 18:49:30', 74, '8580318', 161, 97, '54863aaa', 'mjh', 'uuu', 90, 87, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'ghgh', 'ffgfg', 163, '2018-03-02T10:58'),
(2, '2018-07-26 18:50:47', 70, '0412', 155, 95, '54863aaa', 'samsung', 'aaaa', 91, 88, 85, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'dsijjdhjddhjsnifny', 'se respaldo data se formateo y se reinserto s', 164, ''),
(3, '2018-02-17 20:21:07', 69, '8580318', 155, 95, 'hghg', 'del3800', 'ghgh', 90, 87, 84, 141, 102, 115, 2, 110, 132, 3, 3, NULL, 2, 3, 3, 2, 'ghghghhhh', 'sdsdh', 163, '2018-06-27T12:59'),
(4, '2018-03-17 20:20:31', 70, '8580318', 126, 95, '54863', '444', 'aaaa', 90, 87, 84, 142, 102, 114, 5, 110, 124, 6, 5, NULL, 6, 0, 0, 6, 'jxkfjxhc', NULL, 163, NULL),
(5, '2018-07-26 18:49:39', 70, '8580318', 59, 96, '54863aaa', 'mjh', 'uuu', 91, 87, 85, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'klklklk', NULL, 164, NULL),
(6, '2018-07-25 20:32:16', 69, '8580318', 59, 97, '54863aaa', 'samsung', 'klll', 90, 88, 84, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'ghgh', NULL, 164, NULL),
(7, '2018-07-26 14:16:27', 70, '8580318', 51, 96, '54863aaa', 'mjh', 'klll', 90, 88, 84, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'asa', 'se formateo el equipo', 165, '2020-03-04T15:01'),
(8, '2018-08-08 17:57:54', 71, '0412', 160, 97, 'jioj', 'vit', 'i', 91, 88, 85, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'sdsdsds', NULL, 163, NULL),
(9, '2018-08-08 17:58:16', 70, '0412', 59, 96, 'sdsds', 'sdsd', 'dsds', 90, 87, 84, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'sdsdsdsdsdsd', NULL, 163, NULL),
(11, '2018-08-08 18:03:08', 70, '0412', 161, 99, 'gfgf', 'gffgf', 'gfggfg', 90, 88, 85, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'fgfgfgf', NULL, 163, NULL),
(12, '2018-08-08 18:06:24', 70, '0412', 115, 99, 'kkjkjk', 'jkjkj', 'jkjk', 90, 87, 84, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000', NULL, 163, NULL),
(13, '2018-10-23 13:26:00', 71, '8580318', 119, 95, '54863aaa', '444', 'klll', 91, 88, 85, 142, 103, 115, 5454, 110, 137, 4, 4, NULL, 3, 0, 0, 3, '2323', NULL, 163, NULL);
...
(221, '2018-10-11 15:48:09', 70, '3888000', 116, 76, '107', '2018-10-01', '0000-00-00', 64, 78, 'No se pudieron verificar los siguientes procesos: \r\nâ€¢        Solicitud de localizaciÃ³n de elementos  â€¢ Solicitud de intercambio de informaciÃ³n â€¢ Solicitud asistencia judicial/penal internacional â€¢ Incluir y consultar carta rogatoria â€¢ Incluir y consultar oficio de traslado de persona repatriada â€¢Incluir y consultar orden de detenciÃ³n con fines de extradiciÃ³n â€¢Incluir y consultar acta de entrega â€¢        Asignar nomenclatura internacional a documentos â€¢        Asignar nomenclatura internacional a expedientes\r\nPor cuanto no se refleja informaciÃ³n pertinente para completar los mismos. Se sugiere verificar procesos mencionados, realizar los cambios pertinentes para completar la informaciÃ³n y poder hacer  las comprobaciones completas ', NULL, NULL, 13),
...
(381, '2018-10-23 17:59:17', 71, '8584123', 99, 63, '344', '2018-10-23', '0000-00-00', 66, 67, '23333333333333333333333333333333333', NULL, NULL, 12);

-- --------------------------------------------------------

--
-- Table structure for table `requerimientos_supervisor`
--
...
--
-- Dumping data for table `requerimientos_supervisor`
--
...
--
-- Table structure for table `requerimiento_analista`
--
...
--
-- Dumping data for table `requerimiento_analista`
--

INSERT INTO `requerimiento_analista` (`id`, `usuario_id`, `requerimiento_id`) VALUES
(25, 4, 61),
(34, 4, 74),
(36, 4, 76),
(37, 4, 77),
...
--
-- Table structure for table `requerimiento_has_persona`
--
...
--
-- Dumping data for table `requerimiento_has_persona`
--
...
(5, 160, 71, '8580318', 65, 'fgfgf', 'jhjjhjhjjh', 'hjhjh', 168, '2018-07-30 17:46:38.015661', '2018-06-29T14:01'),
(6, 161, 71, '8580318', 59, 'ojkooskdo', NULL, NULL, 167, '2017-07-30 14:59:27.775837', NULL),
(9, 159, 71, '8580318', 51, 'sdsdsdds', NULL, NULL, 167, '2017-07-30 14:59:35.333280', NULL),
(10, 159, 69, '8580318', 160, 'sdsdsdds', NULL, NULL, 167, '2017-07-30 14:59:41.590884', NULL),
(11, 145, 71, '8580318', 160, 'vfdjid', NULL, NULL, 168, '2018-07-30 14:59:45.063425', NULL),
(12, 161, 70, '8580318', 161, 'ujujuj', 'fff', 'fff', 167, '2018-07-30 14:59:50.554629', '2018-06-29T14:01'),
(13, 146, 70, '8580318', 102, 'dsdsd', NULL, NULL, 167, '2018-07-30 14:59:59.080460', NULL),
(14, 159, 70, '8580318', 76, 'hghghgssss', 'sss', 'ssss', 168, '2018-07-20 20:20:42.287544', ''),
(15, 147, 70, '8580318', 160, 'sojos', 'hhhh', 'hhhhhh', 167, '2018-07-20 20:19:10.947372', '2018-06-29T14:01'),
(17, 169, 69, '8580318', 173, '11111', NULL, NULL, 167, '2018-10-23 13:23:31.430324', NULL),
(18, 160, 69, '8589632', 164, '11111111111111111111111111111111', NULL, NULL, 167, '2018-10-23 18:25:05.631462', NULL),
(19, 161, 70, '8580318', 130, '54545', NULL, NULL, 167, '2018-10-24 19:05:07.740878', NULL),
(20, 159, 71, '8580318', 73, '8777777777777', NULL, NULL, 167, '2018-10-24 19:10:46.413405', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `soporte_analista`
--
...
--
-- Dumping data for table `soporte_analista`
--

INSERT INTO `soporte_analista` (`id`, `persona_a_id`, `soporte_id`) VALUES
(1, 4, 5),
(2, 4, 6),
(5, 4, 9),
(6, 4, 10),
...
--
-- Table structure for table `soporte_persona`
--
...
--
-- Dumping data for table `soporte_persona`
--
...
(5, 'csoto', '01507881d7647a8524a9cbafbcd813ef', 'hola', 'chao', 5, 92),
...
(8, 'acontrer', 'ad6f41491285f9d6f36cabf813cb00eb', 'nombre de tu hijo', 'joshua', 49, 82),
(10, 'juancho', '01507881d7647a8524a9cbafbcd813ef', 'quien tiene la culpa?', 'maria la bollera', 48, 92),
(12, 'yg7724', '827ccb0eea8a706c4c34a16891f84e7b', 'nombre de mi mama', 'mirian', 71, 82),
...
--
-- Indexes for table `micro_analista`
--
...
--
-- Indexes for table `micro_persona`
--
...
--
-- Indexes for table `micro_tecnico`
--
...
--
-- Indexes for table `micro_tickets`
--
...
--
-- Indexes for table `requerimientos_supervisor`
--
...
--
-- Indexes for table `requerimiento_analista`
--
...
--
-- Indexes for table `requerimiento_has_persona`
--
...
--
-- Indexes for table `soporte_analista`
--
...
--
-- Indexes for table `soporte_persona`
--
...
--
-- Indexes for table `soporte_tecnico`
--
...
--
-- AUTO_INCREMENT for table `micro_analista`
--
ALTER TABLE `micro_analista`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `micro_persona`
--
ALTER TABLE `micro_persona`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `micro_tecnico`
--
ALTER TABLE `micro_tecnico`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `micro_tickets`
--
ALTER TABLE `micro_tickets`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
-- AUTO_INCREMENT for table `requerimientos_supervisor`
--
ALTER TABLE `requerimientos_supervisor`
  MODIFY `id` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=357;

--
-- AUTO_INCREMENT for table `requerimiento_analista`
--
ALTER TABLE `requerimiento_analista`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=323;

--
-- AUTO_INCREMENT for table `requerimiento_has_persona`
--
ALTER TABLE `requerimiento_has_persona`
...
--
-- AUTO_INCREMENT for table `soporte_analista`
--
ALTER TABLE `soporte_analista`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `soporte_persona`
--
ALTER TABLE `soporte_persona`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `soporte_tecnico`
--
ALTER TABLE `soporte_tecnico`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- Constraints for table `micro_analista`
--
ALTER TABLE `micro_analista`
...
--
-- Constraints for table `micro_persona`
--
ALTER TABLE `micro_persona`
...
--
-- Constraints for table `micro_tecnico`
--
ALTER TABLE `micro_tecnico`
...
--
-- Constraints for table `micro_tickets`
--
ALTER TABLE `micro_tickets`
...
--
-- Constraints for table `requerimientos_supervisor`
--
ALTER TABLE `requerimientos_supervisor`
...
--
-- Constraints for table `requerimiento_analista`
--
ALTER TABLE `requerimiento_analista`
...
--
-- Constraints for table `requerimiento_has_persona`
--
ALTER TABLE `requerimiento_has_persona`
...
--
-- Constraints for table `soporte_analista`
--
ALTER TABLE `soporte_analista`
...
--
-- Constraints for table `soporte_persona`
--
ALTER TABLE `soporte_persona`
...
--
-- Constraints for table `soporte_tecnico`
--
ALTER TABLE `soporte_tecnico`
